...
| [**nanollama**](https://github.com/ariannamethod/nanollama) | 🦙 **NANOLLAMA — PyTorch-Free Llama 3 Inference.** A fork of nanoGPT/nanochat, surgically stripped to pure Llama 3. No PyTorch, no CUDA bloat — just raw C inference, llama.cpp-compatible GGUF weights. Runs Meta's beast on your laptop. Single-file. Hackable. Fast. The missing minimal runtime for the Llama 3 ecosystem. |
